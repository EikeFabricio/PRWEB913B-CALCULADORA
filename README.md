Projeto de uma calculadora, básica, usando CSS, HTML e JavaScript referente a nota do primeiro bimestre no componente WEB1 (Programação p/ WEB) requerido pelo professor Flávio.
